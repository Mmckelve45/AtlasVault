...
class LightModeColors {
  ...
  // Set app background/surface to pure white for a clean look
...
// Vibrant glow palette for colorful shadows (kept in theme to avoid hard-coding elsewhere)
class GlowColors {
  // Light mode vibrant accents
  static const Color lightA = Color(0xFF34D399); // emerald
  static const Color lightB = Color(0xFF60A5FA); // blue
  static const Color lightC = Color(0xFFF472B6); // pink

  // Dark mode vibrant accents (slightly stronger hues)
  static const Color darkA = Color(0xFF10B981); // emerald
  static const Color darkB = Color(0xFF3B82F6); // blue
  static const Color darkC = Color(0xFFEC4899); // pink

  static List<Color> byBrightness(Brightness brightness) =>
      brightness == Brightness.dark
          ? const [darkA, darkB, darkC]
          : const [lightA, lightB, lightC];
}
